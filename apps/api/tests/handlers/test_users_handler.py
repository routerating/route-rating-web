...
class TestCreateUsersHandlers(TestBase):
    ...
    def test_create_valid_basic_user(self):
        ...
        self.assertEqual(self.valid_new_user.first_name, user.first_name)
        self.assertEqual(self.valid_new_user.last_name, user.last_name)
        self.assertEqual(self.valid_new_user.phone_number, user.phone_number)
